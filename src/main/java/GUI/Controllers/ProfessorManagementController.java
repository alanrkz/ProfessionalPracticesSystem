 ...
 * @author ELLIN JV
 */
public class ProfessorManagementController implements Initializable {
    ...
    @FXML
    private Button buttonRegisterNewProfessor;
    @FXML
    ...
    private void registerNewProfessor () {
        ...
        try {
            ...
            Stage currentStage = (Stage) buttonRegisterNewProfessor.getScene().getWindow();
            currentStage.hide();

            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/ProfessorRegistrationForm.fxml"));
            Parent root = loader.load();

            Stage stage = new Stage();
            stage.setScene(new Scene(root));
            stage.setTitle("Formulario - Registro de Profesor");
